...
@section('content')
    ...
    <div class="card mt-3" id="list">
        <div class="card-header">
            <span class="fs-2" style="margin: auto 10px;">لیست کتب رزرو شده</span>
        </div>
        <div class="card-body">
            <div id="table">
                @include('frontend.reserves.partial')
            </div>
        </div>
    </div>
@endsection
@section('script')
    <script>
        ...
        let search_url = "{{ route('panel.reserves.search') }}";
    </script>
    <script src="{{ asset('js/customize/frontend/reserves.js') }}"></script>
@endsection
