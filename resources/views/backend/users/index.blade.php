...
@section('content')
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('users.create') }}">
                                <button type="button" class="btn btn-primary">افزودن کاربر</button>
                            </a>
                        </div>
    ...
    <!-- Reserve Modal -->
    <div id="reserveModal" class="modal fade bearingsmodal" tabindex="-1" role="dialog"
        aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    رزرو کتاب برای کاربر <span id="user"></span>
                </div>
                            ...
                            <div class="card-title w-100">
                                <div class="d-flex align-items-center position-relative my-1 w-100">
                                    ...
                                    <input id="search_input_modal" type="text" data-kt-customer-table-filter="search"
                                        ...
                                        placeholder="نام کتاب و یا بارکد را جستجو کنید ..." />
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
